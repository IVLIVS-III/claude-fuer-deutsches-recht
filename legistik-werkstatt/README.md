...
| `aa-voelkerrecht-und-vertragsgesetzgebung` | Wenn es um Völkerrecht und Vertragsgesetzgebung (AA) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. |
| `aenderungs-formular-portal-einreichungslogik` | Wenn es um Änderungs: Formular, Portal und Einreichungslogik in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswahlstichwort: Änder... |
| `aenderungs-formular-portal-und-einreichung` | Wenn es um Änderungs: Formular, Portal und Einreichungslogik in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswahlstichwort: Änder... |
...
| `bmf-geldwaesche-und-sanktionsrecht` | Wenn es um Geldwäscherecht und Sanktionsrecht (BMF) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. |
...
| `bmftr-forschungsfoerderung` | Wenn es um Forschungsförderung und Ressortforschung (BMFTR) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswah... |
| `bmftr-forschungsfoerderung-und-ressortforschung` | Wenn es um Forschungsförderung und Ressortforschung (BMFTR) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswah... |
...
| `bmftr-kuenstliche-intelligenz` | Wenn es um Künstliche Intelligenz und Technikregulierung (BMFTR) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. A... |
| `bmftr-kuenstliche-raumfahrt` | Wenn es um Künstliche Intelligenz und Technikregulierung (BMFTR) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. A... |
...
| `bmi-auslaender` | Wenn es um Ausländer- und Staatsangehörigkeitsrecht (BMI) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswahls... |
| `bmi-auslaender-und-staatsangehoerigkeitsrecht` | Wenn es um Ausländer- und Staatsangehörigkeitsrecht (BMI) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswahls... |
| `bmi-bevoelkerungsschutz` | Wenn es um Bevölkerungsschutz und Katastrophenrecht (BMI) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswahls... |
| `bmi-bevoelkerungsschutz-oeffentlicher` | Wenn es um Bevölkerungsschutz und Katastrophenrecht (BMI) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswahls... |
| `bmi-oeffentlicher-dienst-beamtenrecht` | Wenn es um Öffentlicher Dienst und Beamtenrecht (BMI) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswahlstich... |
| `bmi-oeffentlicher-dienst-und-beamtenrecht` | Wenn es um Öffentlicher Dienst und Beamtenrecht (BMI) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswahlstich... |
...
| `bmleh-oekolandbau-pflanzenschutzrecht` | Wenn es um Ökolandbau und Pflanzenschutzrecht (BMLEH) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswahlstich... |
| `bmleh-oekolandbau-und-pflanzenschutzrecht` | Wenn es um Ökolandbau und Pflanzenschutzrecht (BMLEH) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswahlstich... |
...
| `bmv-mobilitaets-und-fuehrerscheinrecht` | Wenn es um Mobilitäts- und Führerscheinrecht (BMV) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. |
...
| `bmv-strassenverkehrsrecht-und-stvg-stvo` | Wenn es um Straßenverkehrsrecht (StVG; StVO) (BMV) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. |
| `bmvg-militaerische-beschaffung` | Wenn es um Militärische Beschaffung und Vergaberecht (BMVg) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswah... |
| `bmvg-militaerische-beschaffung-und-vergaberecht` | Wenn es um Militärische Beschaffung und Vergaberecht (BMVg) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswah... |
...
| `bmwe-aussenwirtschaft` | Wenn es um Außenwirtschaft und Investitionsprüfung (BMWE) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Berechnungstabelle mit Schwellen, Annahmen und Kontrollfragen. Auswahlstichwort:... |
| `bmwe-aussenwirtschaft-und-investitionspruefung` | Wenn es um Außenwirtschaft und Investitionsprüfung (BMWE) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Berechnungstabelle mit Schwellen, Annahmen und Kontrollfragen. Auswahlstichwort:... |
...
| `bmwe-industriepolitik-foerderrecht` | Wenn es um Industriepolitik; Förderrecht; EU-Beihilfen (BMWE) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Ausw... |
| `bmwe-industriepolitik-foerderrecht-und-beihilfen` | Wenn es um Industriepolitik; Förderrecht; EU-Beihilfen (BMWE) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Ausw... |
...
| `bmwsb-stadtentwicklung-foerderprogramme` | Wenn es um Stadtentwicklung und Förderprogramme (BMWSB) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswahlsti... |
| `bmwsb-stadtentwicklung-und-foerderprogramme` | Wenn es um Stadtentwicklung und Förderprogramme (BMWSB) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswahlsti... |
...
| `bmz-humanitaere-hilfe-krisenpraevention` | Wenn es um Humanitäre Hilfe und Krisenprävention (BMZ) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswahlsti... |
| `bmz-humanitaere-hilfe-und-krisenpraevention` | Wenn es um Humanitäre Hilfe und Krisenprävention (BMZ) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. Auswahlsti... |
...
| `entschliessungsantraege-fehlerkatalog` | Wenn es um Entschliessungsanträge Fehlerkatalog in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `europarechtskonformitaet` | Wenn es um Europarechtskonformität in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswahlstichwort: Europarechtskonformität; Arbeit... |
...
| `gesetzesentwurf-kabinett-aa-voelkerrecht` | Wenn es um Gesetzesentwurf Kabinett in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswahlstichwort: Gesetzesentwurf Kabinett Aa Vö... |
...
| `kabinettsentwuerfe-compliance-dokumentation-und-akte` | Wenn es um Kabinettsentwürfe: Compliance-Dokumentation und Aktenvermerk in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert ein direkt nutzbares Arbeitsprodukt mit Prüfpunkten, Risiken und nächste... |
...
| `laender-behoerden-gerichts-registerweg` | Wenn es um Länder: Behörden-, Gerichts- oder Registerweg in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswahlstichwort: Länder Be... |
| `laender-landtage-legistik-ministerien` | Wenn es um Länder: Behörden-, Gerichts- oder Registerweg in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswahlstichwort: Länder La... |
...
| `legistik-europarechtskonformitaet-notifizierung` | Wenn es um Europarechtskonformität in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswahlstichwort: Legistik Europarechtskonformitä... |
| `legistik-kabinettsentwurf-ressortabstimmung` | Wenn es um Kabinettsentwürfe: Compliance-Dokumentation und Aktenvermerk in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `legistik-normenkartierung-aenderungsbefehle` | Wenn es um Normenkartierung in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswahlstichwort: Legistik Normenkartierung Änderungsbef... |
| `legw-bmi-auslaender-und-staatsangehoerigkeitsrecht` | Wenn es um Ausländer- und Staatsangehörigkeitsrecht (BMI) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. |
| `legw-bmleh-agrar-und-foerderungsrecht-gak-gap` | Wenn es um Agrar- und Förderungsrecht (GAK; GAP) (BMLEH) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Schnittstellenkarte mit Kollisions-, Zuständigkeits- und Nachweisfragen. |
| `legw-bmwe-aussenwirtschaft-und-investitionspruefung` | Wenn es um Aussenwirtschaft und Investitionsprüfung (BMWE) in Legistik-Werkstatt geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert eine Berechnungstabelle mit Schwellen, Annahmen und Kontrollfragen. |
| `legw-rmap-evaluierung-und-aenderung` | Wenn es um Evaluierung und Änderung von Rulemap-Normen in Legistik-Werkstatt geht: zerlegt Ergebnis, Frist, Zuständigkeit, Beweislast und Gegenposition; liefert eine Gegenprüfung mit Fehler-, Beweis- und Fristencheck. |
...
| `rechtsfolgenabschaetzung-leitfaden` | Wenn es um LegW: Gesetzesfolgenabschätzung in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `ressort-aa` | Wenn es um Ressort-Heranführung AA in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `ressort-bmas` | Wenn es um Ressort-Heranführung BMAS in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `ressort-bmbfsfj` | Wenn es um Ressort-Heranführung BMBFSFJ in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `ressort-bmds` | Wenn es um Ressort-Heranführung BMDS in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswahlstichwort: Ressort Bmds; Arbeitsfeld: Le... |
| `ressort-bmf` | Wenn es um Ressort-Heranführung BMF in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswahlstichwort: Ressort Bmf; Arbeitsfeld: Legi... |
| `ressort-bmftr` | Wenn es um Ressort-Heranführung BMFTR in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `ressort-bmg` | Wenn es um Ressort-Heranführung BMG in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `ressort-bmi` | Wenn es um Ressort-Heranführung BMI in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `ressort-bmjv` | Wenn es um Ressort-Heranführung BMJV in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `ressort-bmleh` | Wenn es um Ressort-Heranführung BMLEH in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `ressort-bmukn` | Wenn es um Ressort-Heranführung BMUKN in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `ressort-bmv` | Wenn es um Ressort-Heranführung BMV in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `ressort-bmvg` | Wenn es um Ressort-Heranführung BMVg in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswahlstichwort: Ressort Bmvg; Arbeitsfeld: Le... |
| `ressort-bmvg-bmwe-bmwsb-bmz` | Wenn es um Ressort-Heranführung BMVg in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswahlstichwort: Ressort Bmvg Bmwe Bmwsb Bmz;... |
| `ressort-bmwe` | Wenn es um Ressort-Heranführung BMWE in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `ressort-bmwsb` | Wenn es um Ressort-Heranführung BMWSB in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `ressort-bmz` | Wenn es um Ressort-Heranführung BMZ in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `ressort-heranfuehrung-bmds` | Wenn es um Ressort-Heranführung BMDS in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswahlstichwort: Ressort Heranführung Bmds; A... |
...
| `ressort-verbaendeanhoerung` | Wenn es um Ressort-Heranführung BMF in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswahlstichwort: Ressort Verbändeanhörung; Ar... |
...
| `rmap-bestimmtheit-und-justitiabilitaet` | Wenn es um Bestimmtheit und Justitiabilität bei Rulemap-Normen in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `schulung-legistik-aenderungs-fraktionen` | Wenn es um Trainerleitfaden Schulung Legistik in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswahlstichwort: Schulung Legistik Än... |
| `spezial-aenderungs-formular-portal-und-einreichung` | Wenn es um Änderungs: Formular, Portal und Einreichungslogik in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `spezial-entschliessungsantraege-red-team-und-qualitaetskontrolle` | Wenn es um Entschliessungsanträge: Red-Team und Qualitätskontrolle in Legistik-Werkstatt geht: zerlegt Ergebnis, Frist, Zuständigkeit, Beweislast und Gegenposition; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `spezial-laender-behoerden-gericht-und-registerweg` | Wenn es um Länder: Behörden-, Gerichts- oder Registerweg in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `verfassungsmaessigkeit-quercheck` | Wenn es um Verfassungsmäßigkeit-Quercheck in Legistik-Werkstatt geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `verordnungsermaechtigung-art80` | Wenn es um Verordnungsermächtigung Art. 80 GG in Legistik-Werkstatt geht: ordnet Sachverhalt, Norm, Beweislast, Gegenargumente und nächsten Schritt; liefert ein direkt nutzbares Arbeitsprodukt mit Prüfpunkten, Risiken und nächstem Schritt. |
