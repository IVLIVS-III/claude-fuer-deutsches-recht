...
| --- | --- | --- | --- |
| Fallkern | Abstimmung: Internationaler Bezug und Schnittstellen | InsO Paragraf 17 | Sofortvermerk mit Ergebnisrichtung, Risiko und nächstem Schritt |
...
| Begründetheit | Abstimmung und Mehrheiten | InsO Paragraf 18 | Tatbestandsmatrix mit Beleg und Gegenargument |
...
### 15.3. Insolvenzplan und StaRUG-Planwerkstatt — Allgemein

Zuständige Stelle bestimmen und Adressaten richtig wählen: Mandant, Gegner, zuständige Behörde oder Gericht, Sachverständige, ggf. EU-/internationale Stelle (siehe Skill-Detail). Output: Ergebnisbaustein mit Risiko, Belegstelle und nächstem Schritt.

### 15.4. Restrukturierungsplan: Fristen, Form, Zuständigkeit und Rechtsweg

Zuständige Stelle bestimmen und Adressaten richtig wählen: Mandant, Gegner, zuständige Behörde oder Gericht, Sachverständige, ggf. EU-/internationale Stelle (siehe Skill-Detail). Output: Ergebnisbaustein mit Risiko, Belegstelle und nächstem Schritt.

### 15.5. StaRUG: Tatbestandsmerkmale, Beweisfragen und Beleglage
...
### 15.6. Anlagen: Mehrparteienkonflikt und Interessenmatrix
...
### 15.8. Asset Deals im Plan Grundstuecke Marken Kundendaten

Asset-Deals im Insolvenzplan strukturieren wenn Grundstuecke Marken oder Kundendaten übertragen werden sollen. Paragrafen 311b 398 BGB Paragrafen 27 ff. MarkenG Paragraf 15 PatG. Output: Ergebnisbaustein mit Risiko, Belegstelle und nächstem Schritt.

### 15.9. Cram: Formular, Portal und Einreichungslogik

Zuständige Stelle bestimmen und Adressaten richtig wählen: Mandant, Gegner, zuständige Behörde oder Gericht, Sachverständige, ggf. EU-/internationale Stelle (siehe Skill-Detail). Output: Ergebnisbaustein mit Risiko, Belegstelle und nächstem Schritt.

### 15.10. Cram-down und Obstruktion

Zuständige Stelle bestimmen und Adressaten richtig wählen: Mandant, Gegner, zuständige Behörde oder Gericht, Sachverständige, ggf. EU-/internationale Stelle (siehe Skill-Detail). Output: Ergebnisbaustein mit Risiko, Belegstelle und nächstem Schritt.

### 15.11. Darstellender Teil
...
### 15.12. Datenraum und Dokumentenregister
