# Richterrecht des Bundes und der Länder — Wissenssammlung für Anwaltspraxis und Codex
...
Das [Deutsche Richtergesetz (DRiG)](https://dejure.org/gesetze/DRiG) ist **das zentrale Statut des deutschen Richterdienstrechts**. Es wurde in der Fassung der Bekanntmachung vom **19. April 1972** (BGBl. I S. 713) neu bekannt gemacht und zuletzt durch Gesetz vom **22. Oktober 2024** (BGBl. I S. 320) mit Wirkung vom 26. Oktober 2024 geändert.

Das DRiG gilt gemäß seinem [§ 2](https://dejure.org/gesetze/DRiG/2.html) ausschließlich für **Berufsrichter**; ehrenamtliche Richter unterliegen nur den für sie ausdrücklich geltenden Bestimmungen (§§ 44–45a DRiG). [§ 1 DRiG](https://dejure.org/gesetze/DRiG/1.html) unterscheidet Berufsrichter und ehrenamtliche Richter. [§ 3 DRiG](https://dejure.org/gesetze/DRiG/3.html) regelt die Dienstherrschaft: Bundesrichter sind Richter im Bundesdienst, Landesrichter sind Richter im Landesdienst.
...
- [**§ 1 DRiG**](https://dejure.org/gesetze/DRiG/1.html): Unterscheidung Berufsrichter / ehrenamtliche Richter
- [**§ 2 DRiG**](https://dejure.org/gesetze/DRiG/2.html): Persönlicher Geltungsbereich (nur Berufsrichter)
- [**§ 3 DRiG**](https://dejure.org/gesetze/DRiG/3.html): Dienstherr (Bund oder Land)
- [**§ 4 DRiG**](https://dejure.org/gesetze/DRiG/4.html): Unvereinbare Aufgaben — Kernregelung für Inkompatibilitäten
...
- [**§ 5 DRiG**](https://dejure.org/gesetze/DRiG/5.html): Befähigung zum Richteramt — Erfordernis der **zwei juristischen Staatsexamina**
- [**§ 5a DRiG**](https://dejure.org/gesetze/DRiG/5a.html): Studium (Regelstudienzeit, Pflichtfächer, Schwerpunktbereich)
- [**§ 5b DRiG**](https://dejure.org/gesetze/DRiG/5b.html): Vorbereitungsdienst (Referendariat, mindestens 2 Jahre)
- [**§ 5c DRiG**](https://dejure.org/gesetze/DRiG/5c.html): Anrechnung einer Ausbildung für den gehobenen Dienst
- [**§ 5d DRiG**](https://dejure.org/gesetze/DRiG/5d.html): Prüfungen und Verordnungsermächtigung
- [**§ 6 DRiG**](https://dejure.org/gesetze/DRiG/6.html): Anerkennung von Prüfungen (insbesondere EU-Recht und bilaterale Abkommen)
- [**§ 7 DRiG**](https://dejure.org/gesetze/DRiG/7.html): Universitätsprofessoren (besitzen die Befähigung zum Richteramt kraft ihres Amtes)

**Dritter Abschnitt: Richterverhältnis (§§ 8–24)**

- [**§ 8 DRiG**](https://dejure.org/gesetze/DRiG/8.html): **Rechtsformen** des Richterdienstes: Richter auf Lebenszeit, auf Zeit, auf Probe, kraft Auftrags
- [**§ 9 DRiG**](https://dejure.org/gesetze/DRiG/9.html): **Allgemeine Berufungsvoraussetzungen** — Befähigung zum Richteramt (§ 5 DRiG), Eintritt für die freiheitlich-demokratische Grundordnung (Nr. 2), Mindestalter 30 Jahre für Richter auf Lebenszeit
- [**§ 10 DRiG**](https://dejure.org/gesetze/DRiG/10.html): **Ernennung auf Lebenszeit** — nur nach mindestens dreijähriger Bewährung im Richterverhältnis; planmäßige endgültige Anstellung (s. Art. 97 Abs. 2 GG)
- [**§ 11 DRiG**](https://dejure.org/gesetze/DRiG/11.html): Ernennung auf Zeit — nur bei Bundesrichtern sowie Richtern an Verfassungsgerichten (Landesverfassungsrichter)
- [**§ 12 DRiG**](https://dejure.org/gesetze/DRiG/12.html): **Ernennung auf Probe** — Regeleinstieg für Berufsnachwuchs
- [**§ 13 DRiG**](https://dejure.org/gesetze/DRiG/13.html): Verwendung eines Richters auf Probe — darf nur bei ordentlichen Gerichten und allgemeinen Verwaltungsgerichten verwendet werden
- [**§ 14 DRiG**](https://dejure.org/gesetze/DRiG/14.html): Ernennung zum Richter kraft Auftrags — Beamter auf Lebenszeit kann vorübergehend zum Richter kraft Auftrags ernannt werden
- [**§ 15 DRiG**](https://dejure.org/gesetze/DRiG/15.html): Wirkungen auf das Beamtenverhältnis (ruht während der Tätigkeit als Richter kraft Auftrags)
- [**§ 16 DRiG**](https://dejure.org/gesetze/DRiG/16.html): Dauer der Verwendung als Richter kraft Auftrags (längstens zwei Jahre)
- [**§ 17 DRiG**](https://dejure.org/gesetze/DRiG/17.html): **Ernennung durch Urkunde** — konstitutive Wirkung
- [**§ 17a DRiG**](https://dejure.org/gesetze/DRiG/17a.html): Niederlegung eines Mandats im Deutschen Bundestag
- [**§ 18 DRiG**](https://dejure.org/gesetze/DRiG/18.html): Nichtigkeit der Ernennung (Katalog von Nichtigkeitsgründen)
- [**§ 19 DRiG**](https://dejure.org/gesetze/DRiG/19.html): Rücknahme der Ernennung
- [**§ 19a DRiG**](https://dejure.org/gesetze/DRiG/19a.html): Amtsbezeichnungen
- [**§ 20 DRiG**](https://dejure.org/gesetze/DRiG/20.html): Allgemeines Dienstalter
- [**§ 21 DRiG**](https://dejure.org/gesetze/DRiG/21.html): Entlassung aus dem Dienstverhältnis (allgemeine Voraussetzungen)
- [**§ 22 DRiG**](https://dejure.org/gesetze/DRiG/22.html): **Entlassung eines Richters auf Probe** — bei mangelnder Bewährung
- [**§ 23 DRiG**](https://dejure.org/gesetze/DRiG/23.html): Entlassung eines Richters kraft Auftrags
- [**§ 24 DRiG**](https://dejure.org/gesetze/DRiG/24.html): **Beendigung des Dienstverhältnisses durch richterliche Entscheidung** — für Richter auf Lebenszeit nur durch das Dienstgericht möglich

**Vierter Abschnitt: Unabhängigkeit des Richters (§§ 25–37)** *(ausführlich unter Abschnitt 2)*

- [**§ 25 DRiG**](https://dejure.org/gesetze/DRiG/25.html): Grundsatz der richterlichen Unabhängigkeit
- [**§ 26 DRiG**](https://dejure.org/gesetze/DRiG/26.html): Dienstaufsicht und ihre Grenzen
- [**§ 27 DRiG**](https://dejure.org/gesetze/DRiG/27.html): Übertragung eines Richteramts
- [**§ 28 DRiG**](https://dejure.org/gesetze/DRiG/28.html): Besetzung der Gerichte mit Richtern auf Lebenszeit
- [**§ 29 DRiG**](https://dejure.org/gesetze/DRiG/29.html): Besetzung der Gerichte mit Richtern auf Probe, Richtern kraft Auftrags und abgeordneten Richtern — zeitliche und sachliche Beschränkungen
- [**§ 30 DRiG**](https://dejure.org/gesetze/DRiG/30.html): **Versetzung und Amtsenthebung** — nur durch richterliche Entscheidung
- [**§ 31 DRiG**](https://dejure.org/gesetze/DRiG/31.html): Versetzung im Interesse der Rechtspflege — Katalog der Voraussetzungen, u.a. Nr. 3: schwere Beeinträchtigung der Rechtspflege
- [**§ 32 DRiG**](https://dejure.org/gesetze/DRiG/32.html): Veränderung der Gerichtsorganisation (Umorganisation als verfassungskonformer Versetzungsgrund)
- [**§ 33 DRiG**](https://dejure.org/gesetze/DRiG/33.html): Belassung des vollen Gehalts bei Versetzung
- [**§ 34 DRiG**](https://dejure.org/gesetze/DRiG/34.html): Versetzung in den Ruhestand wegen Dienstunfähigkeit
- [**§ 35 DRiG**](https://dejure.org/gesetze/DRiG/35.html): **Vorläufige Untersagung der Amtsgeschäfte** (Suspendierung) bei schwerwiegendem Dienstvergehen — Entscheidung durch das Dienstgericht
- [**§ 36 DRiG**](https://dejure.org/gesetze/DRiG/36.html): Mitgliedschaft in einer Volksvertretung oder Regierung — **Ruhen der Befugnisse** aus dem Richterdienstverhältnis
- [**§ 37 DRiG**](https://dejure.org/gesetze/DRiG/37.html): Abordnung

**Fünfter Abschnitt: Besondere Pflichten des Richters (§§ 38–43)**

- [**§ 38 DRiG**](https://dejure.org/gesetze/DRiG/38.html): **Richtereid** — Pflicht zur Leistung vor Amtsantritt; Eidesformel beinhaltet Treue zur freiheitlich-demokratischen Grundordnung
- [**§ 39 DRiG**](https://dejure.org/gesetze/DRiG/39.html): **Wahrung der Unabhängigkeit** — der Richter hat sich innerhalb und außerhalb seines Amtes so zu verhalten, dass das Vertrauen in seine Unabhängigkeit nicht gefährdet wird
- [**§ 40 DRiG**](https://dejure.org/gesetze/DRiG/40.html): Schiedsrichter und Schlichter — nur mit Genehmigung des Dienstvorgesetzten
- [**§ 41 DRiG**](https://dejure.org/gesetze/DRiG/41.html): Rechtsgutachten — darf der Richter grundsätzlich nicht erstatten
- [**§ 42 DRiG**](https://dejure.org/gesetze/DRiG/42.html): Nebentätigkeiten in der Rechtspflege (z.B. Sachverständige, Treuhänder)
- [**§ 43 DRiG**](https://dejure.org/gesetze/DRiG/43.html): **Beratungsgeheimnis** — Verletzung ist strafbar (§ 353b StGB)
...
- [**§ 46 DRiG**](https://dejure.org/gesetze/DRiG/46.html): **Geltung des Bundesbeamtenrechts** — für Bundesrichter gelten die allgemeinen Vorschriften des Bundesbeamtenrechts sinngemäß, soweit das DRiG nichts Besonderes bestimmt
- [**§ 47 DRiG**](https://dejure.org/gesetze/DRiG/47.html): Bundespersonalausschuss in Richterangelegenheiten
- [**§ 48 DRiG**](https://dejure.org/gesetze/DRiG/48.html): Eintritt in den Ruhestand (Altersgrenze für Bundesrichter: Vollendung des 67. Lebensjahres)
- [**§ 48a–48d DRiG**](https://dejure.org/gesetze/DRiG/48a.html): Teilzeitbeschäftigung, Beurlaubung, Arbeitsmarktgründe, berufliches Fortkommen

**Zweiter Abschnitt: Richtervertretungen (§§ 49–60)**

- [**§ 49 DRiG**](https://dejure.org/gesetze/DRiG/49.html): Richterrat und Präsidialrat
- [**§ 50–51 DRiG**](https://dejure.org/gesetze/DRiG/50.html): Zusammensetzung und Wahl des Richterrats
- [**§ 52 DRiG**](https://dejure.org/gesetze/DRiG/52.html): Aufgaben des Richterrats (Mitbestimmung, Mitwirkung)
- [**§ 54 DRiG**](https://dejure.org/gesetze/DRiG/54.html): Bildung des **Präsidialrats** bei den obersten Bundesgerichten
- [**§ 55 DRiG**](https://dejure.org/gesetze/DRiG/55.html): Aufgabe des Präsidialrats — **Stellungnahme zu Richterernennungen** (Art. 95 Abs. 2 GG i.V.m. Richterwahlgesetz)
- [**§ 56–57 DRiG**](https://dejure.org/gesetze/DRiG/56.html): Einleitung der Beteiligung, Stellungnahme des Präsidialrats

**Dritter Abschnitt: Dienstgericht des Bundes (§§ 61–68)** *(ausführlich unter Abschnitt 6)*

- [**§ 61 DRiG**](https://dejure.org/gesetze/DRiG/61.html): Verfassung des Dienstgerichts des Bundes beim BGH
- [**§ 62 DRiG**](https://dejure.org/gesetze/DRiG/62.html): Zuständigkeit
- [**§ 63 DRiG**](https://dejure.org/gesetze/DRiG/63.html): Disziplinarverfahren
- [**§ 64 DRiG**](https://dejure.org/gesetze/DRiG/64.html): Disziplinarmaßnahmen
- [**§ 65 DRiG**](https://dejure.org/gesetze/DRiG/65.html): Versetzungsverfahren
- [**§ 66 DRiG**](https://dejure.org/gesetze/DRiG/66.html): Prüfungsverfahren (Anfechtung von Dienstaufsichtsmaßnahmen)
- [**§ 67 DRiG**](https://dejure.org/gesetze/DRiG/67.html): Urteilsformel im Prüfungsverfahren
- [**§ 68 DRiG**](https://dejure.org/gesetze/DRiG/68.html): Aussetzung von Verfahren

#### **Dritter Teil: Richter im Landesdienst (§§ 71–84)**

- [**§ 71 DRiG**](https://dejure.org/gesetze/DRiG/71.html): Geltung des Beamtenstatusgesetzes (BeamtStG) für Landesrichter
- [**§ 71a DRiG**](https://dejure.org/gesetze/DRiG/71a.html): Anwendung des Beamtenversorgungsgesetzes
- [**§ 72 DRiG**](https://dejure.org/gesetze/DRiG/72.html): Bildung des Richterrats bei Landesgerichten
- [**§ 73 DRiG**](https://dejure.org/gesetze/DRiG/73.html): Aufgaben des Richterrats (Mitbestimmung, Mitwirkung)
- [**§ 74 DRiG**](https://dejure.org/gesetze/DRiG/74.html): Bildung des Präsidialrats der Landesgerichte
- [**§ 75 DRiG**](https://dejure.org/gesetze/DRiG/75.html): Aufgaben des Präsidialrats der Länder
- [**§ 76 DRiG**](https://dejure.org/gesetze/DRiG/76.html): **Altersgrenzen** für Landesrichter — Ermächtigung der Länder, Altersgrenzen festzusetzen (idR 67 Jahre)
- [**§ 76a DRiG**](https://dejure.org/gesetze/DRiG/76a.html): Teilzeitbeschäftigung
- [**§ 77 DRiG**](https://dejure.org/gesetze/DRiG/77.html): **Errichtung von Landesdienstgerichten** — Pflicht der Länder zur Einrichtung von Richterdienstgerichten
- [**§ 78 DRiG**](https://dejure.org/gesetze/DRiG/78.html): Zuständigkeit der Landesdienstgerichte
- [**§ 79 DRiG**](https://dejure.org/gesetze/DRiG/79.html): Rechtszug (Revision zum BGH – Dienstgericht des Bundes)
- [**§ 80–83 DRiG**](https://dejure.org/gesetze/DRiG/80.html): Revision, Verfahrensvorschriften
- [**§ 84 DRiG**](https://dejure.org/gesetze/DRiG/84.html): Verfassungsrichter der Länder — Status der Landesverfassungsrichter

#### **Vierter Teil (§§ 85–126)**

- §§ 85–104: Änderung von Bundesrecht (historisch)
- [**§ 109 DRiG**](https://dejure.org/gesetze/DRiG/109.html): Befähigung zum Richteramt (Überleitungsvorschrift)
- [**§ 112 DRiG**](https://dejure.org/gesetze/DRiG/112.html): Anerkennung ausländischer Prüfungen und im Ausland erworbener Ausbildungsnachweise
- [**§ 112a DRiG**](https://dejure.org/gesetze/DRiG/112a.html): Gleichwertigkeitsprüfung für die Zulassung zum juristischen Vorbereitungsdienst
- [**§ 120 DRiG**](https://dejure.org/gesetze/DRiG/120.html): Technische Mitglieder des Bundespatentgerichts
- [**§ 122 DRiG**](https://dejure.org/gesetze/DRiG/122.html): Staatsanwälte — partielle Anwendung des DRiG auf Staatsanwälte
- [**§ 123 DRiG**](https://dejure.org/gesetze/DRiG/123.html): Besetzung der Berufsgerichte für Rechtsanwälte
- [**§ 124 DRiG**](https://dejure.org/gesetze/DRiG/124.html): Laufbahnwechsel
- [**§ 126 DRiG**](https://dejure.org/gesetze/DRiG/126.html): Inkrafttreten
...
[**Art. 97 GG**](https://dejure.org/gesetze/GG/97.html) enthält zwei Dimensionen der richterlichen Unabhängigkeit:
...
- [**BVerfGE 14, 56**](https://dejure.org/dienste/vernetzung/rechtsprechung?Gericht=BVerfG&Datum=09.05.1962&Aktenzeichen=2+BvL+13%2F60) (BVerfG, 09.05.1962 — **2 BvL 13/60**): Grundsatzentscheidung zur sachlichen Unabhängigkeit. Die sachliche Unabhängigkeit ist gewährleistet, wenn der Richter seine Entscheidungen frei von Weisungen fällen kann. Die Garantie der persönlichen Unabhängigkeit nach Art. 97 Abs. 2 GG sichert die sachliche Unabhängigkeit institutionell ab. Der Grundsatz der Unversetzbarkeit und der Unabsetzbarkeit gehört zum Wesenskern der Richterstellung (ständige Rechtsprechung seit **BVerfGE 3, 213**).

- **BVerfGE 3, 213** (BVerfG, 1953): Früheste Leitentscheidung. Formulierung des Unversetzbarkeits- und Unabsetzbarkeitsprinzips als konstitutives Element der richterlichen Stellung. Die Justizverwaltung darf weder den Einsatzort (Unversetzbarkeit) noch die Amtszeit (Unabsetzbarkeit) gegen den Willen des Richters nachträglich verändern (stRspr. seitdem: BVerfGE 3, 213; 4, 331; 14, 56; 18, 241).

- [**BVerfGE 26, 79**](https://dejure.org/dienste/vernetzung/rechtsprechung?Text=BVerfGE+26%2C+79) (BVerfG, 1969): Verbot jeder vermeidbaren, auch mittelbaren, subtilen und psychologischen Einflussnahme der Exekutive auf die Ausübung spezifisch richterlicher Tätigkeiten.

- [**BVerfG 2 BvR 1473/20**](https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/DE/2021/11/rk20211111_2bvr147320.html) (BVerfG, Beschluss vom 11.11.2021): Dienstaufsicht und quantitative Erledigungsleistung. Der Vorhalt ordnungswidriger Amtsgeschäfte und die Ermahnung zur unverzögerten Erledigung (§ 26 Abs. 2 DRiG) beeinträchtigen den Richter grundsätzlich nicht in seiner richterlichen Unabhängigkeit. Die Grenze wird erst überschritten, wenn dem Richter damit indirekt ein Pensum abverlangt wird, welches sich allgemein, also auch von anderen Richtern, sachgerecht nicht mehr bewältigen lässt.
...
[**§ 26 DRiG**](https://dejure.org/gesetze/DRiG/26.html) — Wortlaut:
...
[**Art. 101 Abs. 1 Satz 2 GG**](https://dejure.org/gesetze/GG/101.html): „Niemand darf seinem gesetzlichen Richter entzogen werden."
...
[**Art. 95 Abs. 2 GG**](https://dejure.org/gesetze/GG/95.html):
...
**BVerfG, Beschluss vom 20. September 2016 — [2 BvR 2453/15](https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/DE/2016/09/rs20160920_2bvr245315.html):** Grundsatzentscheidung zur Bundesrichterwahl. Kernaussagen:
...
[**Art. 98 Abs. 4 GG**](https://dejure.org/gesetze/GG/98.html): Die Länder können bestimmen, dass über die Anstellung der Landesrichter der Landesjustizminister gemeinsam mit einem Richterwahlausschuss entscheidet.
...
OVG Schleswig-Holstein, Beschluss vom 21.10.2019 — [**2 MB 3/19**](https://dejure.org/dienste/vernetzung/rechtsprechung?Gericht=OVG+Schleswig-Holstein&Datum=21.10.2019&Aktenzeichen=2+MB+3%2F19): Die Einsetzung eines Richterwahlausschusses im Sinne des Art. 98 Abs. 4 GG dient der Verbreiterung der Legitimationsbasis der ausgewählten Richter. Der Ausschuss hat Beurteilungs- und Auswahlermessen; die gerichtliche Kontrolle prüft hauptsächlich Fehler bei Sachverhaltsgrundlage und Verfahren.
...
**BVerfG, Plenumsbeschluss vom 22. Mai 2025** ([Pressemitteilung](https://www.bundesverfassungsgericht.de/SharedDocs/Pressemitteilungen/DE/2025/bvg25-045.html)): Das Plenum hat gemäß § 7a BVerfGG Vorschläge für eine Nachfolge-Wahl beschlossen, nachdem der Bundestag seine Wahl nicht in überschaubarer Zeit vorgenommen hatte — dies illustriert den neu eingeführten Selbstvorschlags-Mechanismus als Sicherungsinstrument gegen Blockaden.
...
[**§ 5 Abs. 1 DRiG**](https://dejure.org/gesetze/DRiG/5.html):
...
[**§ 10 DRiG**](https://dejure.org/gesetze/DRiG/10.html): Zum Richter auf Lebenszeit darf ernannt werden, wer nach einem Richterverhältnis auf Probe **mindestens drei Jahre** als Richter tätig gewesen ist. Darüber hinaus muss er sich als für das Amt auf Lebenszeit **geeignet erwiesen** haben.
...
[**BVerfG, Beschluss vom 22. März 2018 — 2 BvR 780/16**](https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/DE/2018/03/rs20180322_2bvr078016.html): §§ 17 Nr. 3, 18 VwGO zur Ernennung von Beamten auf Lebenszeit zum Richter auf Zeit sind mit dem Grundgesetz vereinbar; die wiederholte Bestellung desselben Beamten nach Ablauf der Amtszeit ist allerdings ausgeschlossen (verfassungskonforme Auslegung).
...
Die **R-Besoldung** (Richter- und Staatsanwaltsbesoldung) ist im [**Bundesbesoldungsgesetz (BBesG)**](https://www.gesetze-im-internet.de/bbesg/) geregelt. Seit der Föderalismusreform I (2006) sind die Länder eigenständig für die Besoldung ihrer Richter zuständig; der Bund regelt nur noch die Bundesrichterbesoldung.
...
#### **BVerfG, Urteil vom 5. Mai 2015 — [2 BvL 17/09](https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/DE/2015/05/ls20150505_2bvl001709.html) u.a.**

Datum: 05.05.2015 — Aktenzeichen: **2 BvL 17/09**, **2 BvL 18/09**, **2 BvL 3/12**, **2 BvL 4/12**, **2 BvL 5/12**, **2 BvL 6/12**, **2 BvL 1/14**

**Kernaussagen:**

1. Der weite Entscheidungsspielraum des Gesetzgebers bei der amtsangemessenen Alimentierung wird durch einen **Fünf-Parameter-Test** begrenzt. Bei Erfüllung der Mehrzahl der Parameter besteht eine **Vermutung verfassungswidriger Unterbesoldung**.

2. **Die fünf Parameter:**
...
3. **Ergebnis:** R-1-Besoldung in **Sachsen-Anhalt** für die Jahre 2008–2010 ist mit Art. 33 Abs. 5 GG **unvereinbar**. Neuregelung bis 1. Januar 2016. Die R-1-Besoldung in Nordrhein-Westfalen (2003) und Rheinland-Pfalz (R 3, 2012/2013) sind hingegen verfassungsgemäß.

4. Das Alimentationsprinzip muss mit anderen Verfassungswerten (insbesondere Art. 109 Abs. 3 Satz 1 GG — Schuldenbremse) im Wege der **praktischen Konkordanz** abgewogen werden.

#### **BVerfG, Beschluss vom 4. Mai 2020 — [2 BvL 4/18](https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/DE/2020/05/ls20200504_2bvl000418.html)**
...
#### **BVerfG, Beschluss vom 17. September 2025 — [2 BvL 20/17 u.a.](https://dejure.org/dienste/vernetzung/rechtsprechung?Gericht=BVerfG&Datum=17.09.2025&Aktenzeichen=2+BvL+20%2F17)**
...
[**§ 61 DRiG**](https://dejure.org/gesetze/DRiG/61.html) — Verfassung:
...
[**§ 62 DRiG**](https://dejure.org/gesetze/DRiG/62.html) — Das Dienstgericht des Bundes entscheidet über:
...
[**BGH — Dienstgericht des Bundes, Urteil vom 1. März 2022 — RiZ 2/16**](https://dejure.org/dienste/vernetzung/rechtsprechung?Text=RiZ+2%2F16): Grundsatzentscheidung zur Abgrenzung von Prüfungsverfahren (§ 66 DRiG) und Disziplinarverfahren (§ 63 DRiG). Vorgänge, die ein Disziplinarverfahren betreffen, können nicht gleichzeitig zum Gegenstand eines Prüfungsverfahrens gemacht werden.

### 6.3 Dienstgerichte der Länder (§§ 77–83 DRiG)

[**§ 77 DRiG**](https://dejure.org/gesetze/DRiG/77.html): **Jedes Land ist verpflichtet**, ein oder mehrere Richterdienstgerichte zu errichten. Die Zusammensetzung und das Verfahren richtet sich nach dem jeweiligen Landesrichtergesetz, soweit das DRiG keine zwingenden Vorschriften enthält.
...
**§ 63 DRiG** verweist für das Disziplinarverfahren gegen Bundesrichter auf das **Bundesdisziplinargesetz (BDG)** entsprechend, soweit das DRiG nichts Besonderes bestimmt. [**§ 64 DRiG**](https://dejure.org/gesetze/DRiG/64.html) enthält den Katalog der Disziplinarmaßnahmen für Bundesrichter:

1. **Verweis** (schärfste Missbilligung)
2. **Geldbuße** (bis zum Betrag der monatlichen Dienstbezüge)
3. **Kürzung der Dienstbezüge** (bis auf die Hälfte für bis zu fünf Jahre)
4. **Versetzung in ein Richteramt mit geringerem Endgrundgehalt**
5. **Entfernung aus dem Dienst** (schwerste Maßnahme — nur bei schwerem Dienstvergehen)
...
**Grundlegend:** BVerfG, Beschluss vom 22. Mai 1975 — **2 BvL 13/73** — [**BVerfGE 39, 334**](https://dejure.org/dienste/vernetzung/rechtsprechung?Gericht=BVerfG&Datum=22.05.1975&Aktenzeichen=2+BvL+13%2F73): Verfassungstreue als Einstellungsvoraussetzung und fortwährendes Erfordernis. Richter müssen jederzeit für die freiheitlich-demokratische Grundordnung eintreten.
...
**Fall Jens Maier (Sachsen):** Richterdienstgericht Sachsen, Urteil vom 1. Dezember 2022 — [**66 DG 2/22**](https://dejure.org/dienste/vernetzung/rechtsprechung?Gericht=Richterdienstgericht+Sachsen&Datum=01.12.2022&Aktenzeichen=66+DG+2%2F22)
...
**Richterdienstgericht Berlin, Urteil vom 13. Oktober 2022 — [DG 1/22](https://dejure.org/dienste/vernetzung/rechtsprechung?Gericht=Richterdienstgericht+Berlin&Datum=15.03.2023&Aktenzeichen=DG+1.23):** Richterin wegen Verdachts der Mitgliedschaft in einer verfassungsfeindlichen Vereinigung vorläufig suspendiert. Eine vorläufig des Dienstes enthobene Richterin muss eine deutliche Einschränkung ihrer Lebensführung hinnehmen, solange keine existenzbedrohende wirtschaftliche Notlage entsteht.
...
[**Art. 97 Abs. 2 GG**](https://dejure.org/gesetze/GG/97.html) enthält ein **absolutes Verbot der Versetzung und Amtsenthebung** ohne richterliche Entscheidung. Nur durch **richterlichen Beschluss oder Urteil** des zuständigen Dienstgerichts können planmäßig endgültig angestellte Richter:
- Entlassen
...
[**§ 30 DRiG**](https://dejure.org/gesetze/DRiG/30.html): Die Versetzung eines Richters auf Lebenszeit oder auf Zeit an eine andere Stelle gegen seinen Willen ist nur zulässig:
1. Durch **gerichtliche Entscheidung** des Dienstgerichts
2. Auf der Grundlage der in §§ 30–32 DRiG abschließend geregelten Gründe

### 8.3 Versetzung im Interesse der Rechtspflege (§ 31 DRiG)

[**§ 31 DRiG**](https://dejure.org/gesetze/DRiG/31.html) — Katalog der Versetzungsgründe im Interesse der Rechtspflege:
...
[**§ 32 DRiG**](https://dejure.org/gesetze/DRiG/32.html): Bei Auflösung oder wesentlicher Änderung des Gerichts oder seines Bezirks ist die Versetzung (auch ohne Dienstgerichtsentscheidung) möglich. Der Richter behält jedoch **das volle Gehalt** (§ 33 DRiG).

**Wichtige Entscheidung:** [**BVerfGE 17, 252**](https://dejure.org/dienste/vernetzung/rechtsprechung?Text=BVerfGE+17%2C+252) (BVerfG, 1963): „Hessischer Richter" — Auch bei der Gerichtsorganisationsänderung darf die Versetzung nicht als verschleiertes Instrument zur Umgehung des Art. 97 Abs. 2 GG eingesetzt werden. Die Verfassungsgarantie schützt den Richter vor allen Formen sachfremder Beeinflussung durch den Dienstherrn.

### 8.5 Aktuelle Rechtsprechung

[**BVerfG, Beschluss vom 22. März 2018 — 2 BvR 780/16**](https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/DE/2018/03/rs20180322_2bvr078016.html): Die Unversetzbarkeit und Unabsetzbarkeit sind konstitutive und unverzichtbare Elemente des Richterdienstverhältnisses. Eine zu enge personelle Verflechtung zwischen Organen der Rechtsprechung und Verwaltung ist unzulässig.

[**BVerfG, Beschluss vom 22. Mai 2025 u.a.**](https://www.bundesverfassungsgericht.de/SharedDocs/Pressemitteilungen/DE/2025/bvg25-057.html): Besuch des Deutschen Richterbundes und der Neuen Richtervereinigung — unterstreicht die institutionelle Verbindung zwischen Richterorganisationen und dem BVerfG im Dialog über Unabhängigkeitsfragen.
...
[**§ 39 DRiG**](https://dejure.org/gesetze/DRiG/39.html) — Verhaltenspflichten des Richters:
...
Aktenzeichen: **1 BvL 1/89** (BVerfG, 12.02.1992), veröffentlicht als [**BVerfGE 85, 337**](https://dejure.org/dienste/vernetzung/rechtsprechung?Gericht=BVerfG&Datum=12.02.1992&Aktenzeichen=1+BvL+1%2F89)
...
Aktenzeichen: [**2 BvR 2628/10**](https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/DE/2013/03/rs20130319_2bvr262810.html)
...
- Das [Verständigungsgesetz (§ 257c StPO)](https://dejure.org/gesetze/StPO/257c.html) ist **verfassungsgemäß**, aber nur innerhalb eines eng begrenzten Rahmens mit ausreichenden Schutzinstrumenten. Der Gesetzgeber hat die dauerhafte Wirksamkeit der Schutzmechanismen zu überwachen.

### 11.3 EuGH C-619/18 — Kommission/Polen (24. Juni 2019)

> **Datum:** 24. Juni 2019 | **Aktenzeichen:** [**C-619/18**](https://eur-lex.europa.eu/legal-content/DE/TXT/?uri=CELEX%3A62018CJ0619) | **Fundstelle:** ECLI:EU:C:2019:531
...
**Vorgeschichte:** Der Bundesminister der Justiz übersandte dem BVerfG mit Schreiben vom 26. Juli 2024 zwei Gesetzentwürfe zur Stärkung der Resilienz des Bundesverfassungsgerichts. Das BVerfG gab mit [Plenumsbeschluss vom 11. September 2024](https://www.bundesverfassungsgericht.de/SharedDocs/Pressemitteilungen/DE/2024/bvg24-075.html) eine Stellungnahme ab.
...
**BVerfG, Plenumsbeschluss vom 22. Mai 2025** ([Pressemitteilung](https://www.bundesverfassungsgericht.de/SharedDocs/Pressemitteilungen/DE/2025/bvg25-045.html)):
...
1. Prof. Dr. Günter Spinner (Vorsitzender Richter am Bundesarbeitsgericht) — 15 Ja-Stimmen
2. Dr. Oliver Klein (Richter am BGH) — 13 Ja-Stimmen
3. Dr. Eva Menges (Vorsitzende Richterin am BGH) — 12 Ja-Stimmen
...
1. **Richterwahl-Reform für oberste Bundesgerichte:** Ob und wie das bestehende System der Bundesrichterwahl (Art. 95 Abs. 2 GG) durch unabhängige Auswahlkommissionen ergänzt werden könnte.

2. **Transparenz der Auswahlkriterien:** Im Nachgang der BVerfG-Entscheidung **2 BvR 2453/15** (2016) sind Justizministerien verstärkt gehalten, Auswahlentscheidungen zu begründen. Dennoch bleiben die faktischen Entscheidungsprozesse im Bundesrichterwahlausschuss weitgehend intransparent.

3. **Schutz von Landesrichtern:** Die in den Ländern unterschiedlich ausgestalteten Richterwahlverfahren (mit oder ohne parlamentarischen Richterwahlausschuss) sind Gegenstand verfassungspolitischer Diskussion. Eine bundeseinheitliche Mindeststandards-Regelung ist mangels Bundeszuständigkeit nach der Föderalismusreform schwierig.

4. **EU-Recht als Schutzschicht:** Die EuGH-Entscheidungen zu Polen schaffen für alle Mitgliedstaaten — einschließlich Deutschland — einen verbindlichen unionsrechtlichen Rahmen der Justizunabhängigkeit, der als zusätzliche Schutzschicht neben dem nationalen Verfassungsrecht wirkt.
...
| Quelle | URL |
|---|---|
| DRiG auf dejure.org | [https://dejure.org/gesetze/DRiG](https://dejure.org/gesetze/DRiG) |
| GG Art. 97 auf dejure.org | [https://dejure.org/gesetze/GG/97.html](https://dejure.org/gesetze/GG/97.html) |
| GG Art. 94–95 auf gesetze-im-internet.de | [https://www.gesetze-im-internet.de/gg/](https://www.gesetze-im-internet.de/gg/) |
| BVerfGG auf gesetze-im-internet.de | [https://www.gesetze-im-internet.de/bverfgg/](https://www.gesetze-im-internet.de/bverfgg/) |
| BVerfGE — Entscheidungen auf bundesverfassungsgericht.de | [https://www.bundesverfassungsgericht.de](https://www.bundesverfassungsgericht.de) |
| EuGH C-619/18 auf eur-lex.europa.eu | [https://eur-lex.europa.eu/legal-content/DE/TXT/?uri=CELEX%3A62018CJ0619](https://eur-lex.europa.eu/legal-content/DE/TXT/?uri=CELEX%3A62018CJ0619) |
...
|---|---|---|---|---|---|
| **BVerfGE 3, 213** | BVerfG | 1953 | Art. 97 GG | Unversetzbarkeit und Unabsetzbarkeit als konstitutive Elemente des Richterdienstverhältnisses (stRspr. bis heute) | [dejure.org](https://dejure.org/dienste/vernetzung/rechtsprechung?Text=BVerfGE+3%2C+213) |
| **2 BvL 13/60** (BVerfGE 14, 56) | BVerfG | 09.05.1962 | Art. 97 GG | Sachliche Unabhängigkeit = Weisungsfreiheit; persönliche Unabhängigkeit sichert sachliche ab | [dejure.org](https://dejure.org/dienste/vernetzung/rechtsprechung?Gericht=BVerfG&Datum=09.05.1962&Aktenzeichen=2+BvL+13%2F60) |
| **BVerfGE 17, 252** | BVerfG | 1963 | Art. 97 II GG | Versetzungsschutz auch bei Gerichtsorganisationsänderung; kein Umgehungsinstrument | [dejure.org](https://dejure.org/dienste/vernetzung/rechtsprechung?Text=BVerfGE+17%2C+252) |
| **BVerfGE 26, 79** | BVerfG | 1969 | Art. 97 GG | Verbot mittelbarer, subtiler und psychologischer Einflussnahme durch Exekutive | [dejure.org](https://dejure.org/dienste/vernetzung/rechtsprechung?Text=BVerfGE+26%2C+79) |
| **1 BvL 1/89** (BVerfGE 85, 337) | BVerfG | 12.02.1992 | Art. 20 III GG | Allgemeiner Justizgewährungsanspruch; Recht auf Zugang zum unabhängigen Gericht | [dejure.org](https://dejure.org/dienste/vernetzung/rechtsprechung?Gericht=BVerfG&Datum=12.02.1992&Aktenzeichen=1+BvL+1%2F89) |
| **2 BvL 27/91** | BVerfG | 08.07.1992 | §§ 61 ff. DRiG | Richterdienstgerichte schützen richterliche Unabhängigkeit, Unversetzbarkeit und Unabsetzbarkeit | [dejure.org](https://dejure.org/dienste/vernetzung/rechtsprechung?Gericht=BVerfG&Datum=08.07.1992&Aktenzeichen=2+BvL+27%2F91) |
| **2 BvR 2453/15** | BVerfG | 20.09.2016 | Art. 95 II GG, Art. 33 II GG | Bundesrichterwahl: Ausschuss muss sich an Art. 33 II GG leiten lassen; Minister muss Verweigerung begründen | [bundesverfassungsgericht.de](https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/DE/2016/09/rs20160920_2bvr245315.html) |
| **2 BvR 780/16** | BVerfG | 22.03.2018 | Art. 97 GG | Richter auf Zeit an einem Verwaltungsgericht verfassungsgemäß; keine Wiederbestellung nach Ende der Amtszeit | [bundesverfassungsgericht.de](https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/DE/2018/03/rs20180322_2bvr078016.html) |
| **2 BvL 17/09** | BVerfG | 05.05.2015 | Art. 33 V GG | R-1-Besoldung SA 2008–2010 verfassungswidrig; Fünf-Parameter-Test; Neuregelung bis 01.01.2016 | [bundesverfassungsgericht.de](https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/DE/2015/05/ls20150505_2bvl001709.html) |
| **2 BvL 4/18** | BVerfG | 04.05.2020 | Art. 33 V GG | R-1 bis R-3 Berlin 2009–2015 verfassungswidrig; Neuregelung bis 01.07.2021 | [bundesverfassungsgericht.de](https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/DE/2020/05/ls20200504_2bvl000418.html) |
| **2 BvR 2628/10** | BVerfG | 19.03.2013 | Art. 97 GG, § 257c StPO | Verständigungsgesetz verfassungsgemäß; richterliche Neutralität als Kern des Richteramts | [bundesverfassungsgericht.de](https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/DE/2013/03/rs20130319_2bvr262810.html) |
| **2 BvR 1473/20** | BVerfG | 11.11.2021 | Art. 97 GG, § 26 DRiG | Dienstaufsicht und Erledigungsdruck; Grenze der Unabhängigkeitsverletzung beim objektiv unmöglichen Pensum | [bundesverfassungsgericht.de](https://www.bundesverfassungsgericht.de/SharedDocs/Downloads/DE/2021/11/rk20211111_2bvr147320.pdf) |
| **2 BvL 20/17** | BVerfG | 17.09.2025 | Art. 33 V GG | Berliner A-Besoldung 2008–2020 überwiegend verfassungswidrig; Gebot der Mindestbesoldung | [bundesverfassungsgericht.de](https://www.bundesverfassungsgericht.de/SharedDocs/Entscheidungen/DE/2025/09/ls20250917_2bvl002017.html) |
| **RiZ 2/16** | BGH Dienstgericht des Bundes | 01.03.2022 | §§ 62, 66, 26 DRiG | Prüfungsverfahren ≠ Disziplinarverfahren; willkürliche Zuteilung als verdeckte Disziplinarmaßnahme | [dejure.org](https://dejure.org/dienste/vernetzung/rechtsprechung?Text=RiZ+2%2F16) |
| **66 DG 1/22** | Richterdienstgericht Sachsen | 24.03.2022 | § 31 Nr. 3 DRiG | Versetzung in Ruhestand wegen öffentlichen Vertrauensverlustes | [dejure.org](https://dejure.org/dienste/vernetzung/rechtsprechung?Gericht=Richterdienstgericht+Sachsen&Datum=24.03.2022&Aktenzeichen=66+DG+1%2F22) |
| **66 DG 2/22** (Fall Maier) | Richterdienstgericht Sachsen | 01.12.2022 | § 31 Nr. 3 DRiG | AfD-Richter Jens Maier darf nicht wieder Richter sein; schwerer Vertrauensverlust in die Unabhängigkeit | [dejure.org](https://dejure.org/dienste/vernetzung/rechtsprechung?Gericht=Richterdienstgericht+Sachsen&Datum=01.12.2022&Aktenzeichen=66+DG+2%2F22) |
| **DG 1/22** | Richterdienstgericht Berlin | 15.03.2023 | § 35 DRiG, § 9 Nr. 2 DRiG | Vorläufige Suspendierung einer Richterin wegen Verdachts der Mitgliedschaft in Terror-Vereinigung | [dejure.org](https://dejure.org/dienste/vernetzung/rechtsprechung?Gericht=Richterdienstgericht+Berlin&Datum=15.03.2023&Aktenzeichen=DG+1.23) |
| **C-619/18** | EuGH | 24.06.2019 | Art. 19 I UAbs. 2 EUV | Polen verletzt richterliche Unabhängigkeit durch rückwirkende Pensionsaltersabsenkung und freies Ermessen des Staatspräsidenten | [eur-lex.europa.eu](https://eur-lex.europa.eu/legal-content/DE/TXT/?uri=CELEX%3A62018CJ0619) |
| **C-585/18, C-624/18, C-625/18** (A.K.) | EuGH (Große Kammer) | 19.11.2019 | Art. 19 I UAbs. 2 EUV, Art. 47 GrCh | Kriterien der Unabhängigkeit für neue polnische Disziplinarkammer; vorlegendes Gericht muss nationale Norm unangewendet lassen wenn Unabhängigkeit verneint wird | [eur-lex.europa.eu](https://eur-lex.europa.eu/search.html?scope=EURLEX&text=C-585/18&lang=de) |
