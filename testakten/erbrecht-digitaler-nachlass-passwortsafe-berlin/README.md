...
| Was | Format | Quelle |
| --- | --- | --- |
| Gesamt-PDF (alles in einer Datei, 16 KB) | PDF | [`gesamt-pdf/erbrecht-digitaler-nachlass-passwortsafe-berlin_gesamt.pdf`](gesamt-pdf/erbrecht-digitaler-nachlass-passwortsafe-berlin_gesamt.pdf) |
...
| `xlsx/nachlassinventar_digital_analog.xlsx` | xlsx/nachlassinventar digital analog.xlsx |

## Arbeitsnotiz

Die Unterlagen ermöglichen Prüfung von Erbfolge, Nachlasssicherung, Auskunft, digitalem Nachlass und Verwertung der Bildrechte, ohne die richtige Verteilung vorzugeben.
