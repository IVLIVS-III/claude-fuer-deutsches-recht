...
| --- | --- | --- | --- |
| Fallkern | Haftungsrisiko-Memo | GG Artikel 20 Absatz 3 | Sofortvermerk mit Ergebnisrichtung, Risiko und nächstem Schritt |
...
| Begründetheit | Juristisches: Fristen, Form, Zuständigkeit und Rechtsweg | BGB Paragraf 133 und Paragraf 157 | Tatbestandsmatrix mit Beleg und Gegenargument |
...
Zuständige Stelle bestimmen und Adressaten richtig wählen: Mandant, Rechtsanwalt, Auftraggeber (intern: Rechtsabteilung), Gegner, ggf. Gericht (bei Vorlage), externer Spezialist. Output: Ergebnisbaustein mit Risiko, Belegstelle und nächstem Schritt.
