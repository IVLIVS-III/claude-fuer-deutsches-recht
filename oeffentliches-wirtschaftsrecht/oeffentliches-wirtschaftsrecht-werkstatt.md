...
| --- | --- | --- | --- |
| Fallkern | Autobahnprojekt Vertrag Scopen | VwVfG Paragraf 35 | Sofortvermerk mit Ergebnisrichtung, Risiko und nächstem Schritt |
...
| Begründetheit | Breitband Vertrag Scopen | VwVfG Paragraf 28 | Tatbestandsmatrix mit Beleg und Gegenargument |
...
Zuständige Stelle bestimmen und Adressaten richtig wählen: Kommune, kommunales Unternehmen, Aufsichtsrat, Kommunalaufsicht, Vergabekammer, EU-KOM (DG COMP), Rechnungshof. Output: Ergebnisbaustein mit Risiko, Belegstelle und nächstem Schritt.
