...
| Skill | Beschreibung |
| --- | --- |
| `abmahnung-loeschung-personalakte-bag-2-azr-782-11` | Wenn es um Abmahnung Löschung Personalakte BAG 2 Azr 782 11 in Fachanwalt Arbeitsrecht geht: ordnet Akteninhalt, Belege, Lücken und Nachforderungen; liefert ein direkt nutzbares Arbeitsprodukt mit Prüfpunkten, Risiken und nächstem Schritt. |
...
| `ar-einfuehrung-mandantenanliegen` | Wenn es um Ar Einführung Mandantenanliegen in Fachanwalt Arbeitsrecht geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `ar-kuendigungspruefung-workflow` | Wenn es um Ar Kündigungsprüfung Workflow in Fachanwalt Arbeitsrecht geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik. |
...
| `betriebsratsanhoerung` | Wenn es um Betriebsratsanhörung nach Paragraf 102 BetrVG vor jeder Kündigung in Fachanwalt Arbeitsrecht geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `betriebsuebergang-widerspruch-paragraf-613a-bgb-spaetlauf` | Wenn es um Betriebsübergang Widerspruch Paragraf 613a BGB Spätlauf in Fachanwalt Arbeitsrecht geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `erstgespraech-mandatsannahme` | Wenn es um Erstgespräch Mandatsannahme in Fachanwalt Arbeitsrecht geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `erstpruefung-und-mandatsziel` | Wenn es um Erstprüfung Und Mandatsziel in Fachanwalt Arbeitsrecht geht: klärt Rolle, Ziel, Frist, Unterlagen und den passenden nächsten Fachskill; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `fazugang-neu-001-kuendigung-durch-boten-beweisvermerk-und-prozes` | Wenn es um Fazugang Neu 001 Kündigung Durch Boten Beweisvermerk Und Prozes in Fachanwalt Arbeitsrecht geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `fazugang-neu-005-kuendigungsfrist-berechnen-bei-unsicherem-zugan` | Wenn es um Fazugang Neu 005 Kündigungsfrist Berechnen Bei Unsicherem Zugan in Fachanwalt Arbeitsrecht geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `fazugang-neu-008-schriftform-kuendigung-original-und-elektronisc` | Wenn es um Fazugang Neu 008 Schriftform Kündigung Original Und Elektronisc in Fachanwalt Arbeitsrecht geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `kuendigung-per-einschreiben-risiken` | Wenn es um Kündigung Per Einschreiben Risiken in Fachanwalt Arbeitsrecht geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `kuendigungsschutzklage` | Wenn es um Kündigungsschutzklage in Fachanwalt Arbeitsrecht geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `low-performer-kuendigung-bag-2-azr-359-02` | Wenn es um Low Performer Kündigung BAG 2 Azr 359 02 in Fachanwalt Arbeitsrecht geht: entwickelt Verhandlungsziel, Vergleichskorridor und Eskalationspfad; liefert eine Verhandlungs- oder Eskalationslinie mit Optionen. |
...
| `massenentlassung-17-kschg-realitaetscheck` | Wenn es um Massenentlassung 17 Kschg Realitätscheck in Fachanwalt Arbeitsrecht geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `scheinselbststaendigkeit-statusfeststellung-bsg-b-12-r-11-18` | Wenn es um Scheinselbstständigkeit Statusfeststellung Bsg B 12 R 11 18 in Fachanwalt Arbeitsrecht geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `unwirksam-fristennotiz-und-naechster-schritt` | Wenn es um Unwirksam Fristennotiz Und Nächster Schritt in Fachanwalt Arbeitsrecht geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `urlaubsabgeltung-verjaehrung-eugh-c-518-20` | Wenn es um Urlaubsabgeltung Verjährung EuGH C 518 20 in Fachanwalt Arbeitsrecht geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `verhandlung-guete-abfindung-arbg` | Wenn es um Verhandlung Güte Abfindung Arbg in Fachanwalt Arbeitsrecht geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik. |
...
| `zugang-kuendigung-bote-beweis` | Wenn es um Zugang Kündigung Bote Beweis in Fachanwalt Arbeitsrecht geht: prüft Frist, Form, Zuständigkeit, Rechtsweg und Sofortmaßnahmen; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
