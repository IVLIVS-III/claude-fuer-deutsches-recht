...
Dieser Fehlerkatalog prüft Arbeitsergebnisse für **Fachanwalt Erbrecht** vor Abgabe, Versand oder Mandantenfreigabe gegen die im Sachgebiet typischen Fehlerquellen — jeweils mit Symptom, Diagnose und Heilung.

## Fehlerkatalog

### 1. Frist falsch berechnet oder übersehen (Ausschlagung 6 Wochen § 1944 BGB)

- **Symptom:** Frist falsch berechnet oder übersehen (Ausschlagung 6 Wochen § 1944 BGB)
...
- **Symptom:** Falsche Zuständigkeit adressiert (richtig: Nachlassgericht (AG))
...
### 4. Beweismittel nicht gesichert (Originaltestament)

- **Symptom:** Beweismittel nicht gesichert (Originaltestament)
...
### 5. Schlüsseldokument fehlt oder veraltet (Testament/Erbvertrag)

- **Symptom:** Schlüsseldokument fehlt oder veraltet (Testament/Erbvertrag)
...
### 6. Normzitat ohne Fassungsprüfung (BGB §§ 1922 ff.)

- **Symptom:** Normzitat ohne Fassungsprüfung (BGB §§ 1922 ff.)
