...
| `anfaenger-antraege-dfg` | Wenn es um Anfänger: Risikoampel, Gegenargumente und Verteidigungslinien in DFG-Förderantrag geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswa... |
| `anfaenger-risikoampel-gegenargumente` | Wenn es um Anfänger: Risikoampel, Gegenargumente und Verteidigungslinien in DFG-Förderantrag geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. Auswa... |
...
| `antraege-zahlen-schwellen-und-berechnung` | Wenn es um Anträge: Zahlen, Schwellenwerte und Berechnung in DFG-Förderantrag geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik. |
| `antraege-zahlen-schwellenwerte-berechnung` | Wenn es um Anträge: Zahlen, Schwellenwerte und Berechnung in DFG-Förderantrag geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `dfg-grossgeraete-und-cluster-antrag` | Wenn es um DFG: Grossgeräte und Cluster in DFG-Förderantrag geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik. |
| `dfg-grundsystem-foerderlinien` | Wenn es um Grundsystem DFG-Förderlinien in DFG-Förderantrag geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik. |
...
| `dfg-praeregistrierung-replication-studies` | Wenn es um Präregistrierung und Replikation in DFG-Förderantrag geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik. |
...
| `dfg-software-veroeffentlichung-spezial` | Wenn es um DFG: Software-Veröffentlichung in DFG-Förderantrag geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik. Auswahlstichwort:... |
| `dfg-software-veroeffentlichung-tieforschung` | Wenn es um DFG: Software-Veröffentlichung in DFG-Förderantrag geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik. Auswahlstichwort:... |
...
| `erstantrag-projektlogik` | Wenn es um Förderantragssteller: Tatbestandsmerkmale, Beweisfragen und Beleglage in DFG-Förderantrag geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
...
| `foerderantragssteller-formalia-red-fuehrung` | Wenn es um Förderantragssteller: Tatbestandsmerkmale, Beweisfragen und Beleglage in DFG-Förderantrag geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert einen verwertbaren Entwurf mit Anträgen, Begründ... |
...
| `fuehrung-schriftsatz-brief-memo-bausteine` | Wenn es um Führung: Schriftsatz-, Brief- und Memo-Bausteine in DFG-Förderantrag geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert eine Fristen- und Risikoampel mit Sofortschritten. |
| `fuehrung-schriftsatz-brief-und-memo-bausteine` | Wenn es um Führung: Schriftsatz-, Brief- und Memo-Bausteine in DFG-Förderantrag geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik. |
...
| `spezial-grosse-compliance-dokumentation-und-akte` | Wenn es um Große: Compliance-Dokumentation und Aktenvermerk in DFG-Förderantrag geht: erstellt den passenden Entwurf aus Sachverhalt, Norm, Beweis und Antrag; liefert einen verwertbaren Entwurf mit Anträgen, Begründung und Anlagenlogik. |
